  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="{{route('data-guru1')}}">Data Guru</a></li>
    ...
    <div class="content">
      <div class="card card-info card-outline">
        ...
        <div class="card-body">
            <form action="{{route('simpan-data1')}}" method="post">
              {{ csrf_field() }}
              ...
              <div class="form-group">
                <input type="text" id="mapel" name="mapel" class="form-control" placeholder="Mapel">
              </div>
              <div class="form-group">
